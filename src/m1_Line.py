...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clone_number = 0
        self.origLine = [start.clone(), end.clone()]
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        new_start = self.start.plus(other_line.start)
        new_end = self.end.plus(other_line.end)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        new_start = self.start.minus(other_line.start)
        new_end = self.end.minus(other_line.end)
        return Line(new_start, new_end)
    ...
    def is_parallel(self, line2):
        ...
        ################################################################
        m1 = round(self.slope(), 12)
        m2 = round(line2.slope(), 12)
        return m1.__eq__(m2)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.start = self.origLine[0]
        self.end = self.origLine[1]
